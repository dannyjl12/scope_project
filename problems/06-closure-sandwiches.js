...
***********************************************************************/
// return a function that accepts a string

// 1. Make a string
// 2. return a new function that takes in the string
        // 2.1. string will add an ingredient
// 3. modify the string with 'and ingredient'
// 3. return the new string

function sandwichMaker() {
  let string = 'One sandwich with tomato';

  return addIngredient = function(ingredient) {
